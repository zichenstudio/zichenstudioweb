document.querySelector('footer').innerHTML = '<hr>' +
    ...
    '技术支持：Pillar | 文案：三哥 | 网站托管：Github & Gitee | 网站部署：Netlify | 图床：sm.ms<br>' +
...
document.querySelector('article:last-child').innerHTML += '<br><br><br><br><br><br>';
document.querySelector('aside article:last-child').innerHTML += '<br><br><br><br><br><br>';
